      ...
      <div className="flex-1 overflow-y-auto py-4 flex flex-col gap-2 min-h-0">
        {messages.length === 0 ? (
          <div className="flex-1 flex flex-col items-center justify-center gap-2 text-center">
            <div className="w-14 h-14 bg-orange-50 dark:bg-orange-950/40 rounded-2xl flex items-center justify-center">
              <CatIcon className="w-7 h-7 text-orange-300 dark:text-orange-500" strokeWidth={1.5} />
            </div>
